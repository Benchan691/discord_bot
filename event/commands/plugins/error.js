...
const Error = {
    ...
    role_permission_admin: function(role){
                      ...
                      .setDescription(`Your Bot don't have permission to edit role ${role}, please open the permission again.`)
                      },  

    role_permission_member: new MessageEmbed()
                      .setColor('#E74C3C')
                      .setTitle("Perrmission error :exclamation: ")
                      .setDescription(`The Bot don't have permission to edit the role, please contact the stuff open the permission`),
    ...
    dictionary: new MessageEmbed()
                          .setColor('#E74C3C')
                          .setTitle("Dictionary Error :exclamation:")
                          .setDescription("There are no such word or your part of speech is incorrect. Please check your input again."),

    database_no_word: new MessageEmbed()
                          .setColor('#E74C3C')
                          .setTitle("Can't find any vocab in database :exclamation:")
                          .setDescription("Please add some vocabculary into database first."),
